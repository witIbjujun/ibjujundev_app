            ...
            return Positioned(
              ...
              child: Row(
                ...
                children: List.generate(
                  eventCount > 4 ? 4 : eventCount, (index) {
                    final event = eventList[index];
                    Color markerColor = event.data["reqGbn"] == "MY" ? WitHomeTheme.wit_black : WitHomeTheme.wit_red;
                    return Text('.',
                      style: WitHomeTheme.NanumHeeadline.copyWith(color: markerColor),
                    );
                  },
                ),
              ),
