...
class SellerProfileChildView extends StatefulWidget {
  final dynamic sllrNo;
  final dynamic appbarYn;

  const SellerProfileChildView(
      {Key? key, required this.sllrNo, required this.appbarYn})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return SellerProfileChildViewState();
  }
}

class SellerProfileChildViewState extends State<SellerProfileChildView> {
  dynamic sellerInfo;
  String storeName = "";
  String serviceArea = "";
  String serviceItem = "";
    ...
    return Padding(
        ...
        child: Column(
          children: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: (sellerInfo?['storeImage'] != null &&
                                      sellerInfo!['storeImage'].isNotEmpty)
                                  ? NetworkImage(
                                      apiUrl + sellerInfo['storeImage'])
                                  : const AssetImage(
            ...
            Container(
              width: double.infinity, // ✅ 배경 너비를 전체로 확장
              ...
              child: Column(
                ...
                children: [
                            ...
                            GestureDetector(
                              ...
                              child: LayoutBuilder(
                                builder: (context, constraints) {
                                  ...
                                  final textStyle = WitHomeTheme.subtitle
                  ...
                  if (!isLoading &&
                      (displayCount < boardList.length || !isLastPage))
                    Center(
