  ...
  Future<void> getSubscribeAptList(dynamic sllrNo) async {
    ...
    if (response != null) {
      setState(() {
        ...
        subscribeAptList = subscribeAptList.reversed.toList();
      });
    } else {
      // 오류 처리
      ScaffoldMessenger.of(context).showSnackBar(
                    ...
                    child: Ink(
                      ...
                      decoration: BoxDecoration(
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: WitHomeTheme.title.copyWith(
                                          fontSize: 16, color: WitHomeTheme.wit_lightGreen),
                                    ),
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: Text(
                                    '구독 중인 아파트가 없습니다.',
                                    style: TextStyle(
                                        fontSize: 16, color: WitHomeTheme.wit_black),
                            ...
                            builder: (context, constraints) {
                              return DottedBorder(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(12.0),
                                  child: Column(
                                    children: List.generate(subscribeAptList.length,
                                            (index) {
                                          var apt = subscribeAptList[index];
                                                ...
                                                Expanded(
                                                  child: Container(
                                                    ...
                                                    child: Text(
                                                      apt['aptName'] ?? '이름 없음',
                                                      style:
                                                      WitHomeTheme.subtitle.copyWith(
                                                        fontSize: 14,
                                                        color: WitHomeTheme.wit_white,
                                                      ),
                        ...
                        TextButton(
                                ...
                                MaterialPageRoute(
                                  builder: (BuildContext context) {
                                    return Scaffold(
                                      ...
                                      body: Container(
                                        child: SellerGroupPurchaseList(sllrNo: sllrNo.toString()),
                                      ),
                                    );
                                  },
                                ),
                          ...
                          style: TextButton.styleFrom(
                            backgroundColor: WitHomeTheme.wit_white,
                            padding: EdgeInsets.only(left: 20.0, top: 10.0, bottom: 10.0, right: 0.0),
                            alignment: Alignment.centerLeft,
                            minimumSize: Size.zero,
                            tapTargetSize: MaterialTapTargetSize.shrinkWrap,
                          ),
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(right: 20.0),
                                child: Icon(Icons.arrow_forward_ios, size: 14, color: WitHomeTheme.wit_black),
                              ),
                            ],
                          ),
                        ),
                        ...
                        TextButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      EstimateRequestDirectList(sllrNo: sllrNo.toString())),
                            );
                          },
                          style: TextButton.styleFrom(
                            backgroundColor: WitHomeTheme.wit_white,
                        ...
                        TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => CardRegisterWebView(
                                  customerUid: sllrNo,
                                  amount: 0,
                                  storeName: sellerInfo['storeName'],
                                ),
